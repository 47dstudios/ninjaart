...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Admin || Ninja Art Online Junior Track</title>
        ...
        <?php
          ...
          if($result) {
            ...
            /*  echo '<img src="../images/products/'.$obj->product_img_name.'"/>'; */
              ...
              echo '<form method="post" name="update-quantity" action="../controller/admin-insert-products.php">';
              echo '<p><strong>Additional Quantity</strong>:</p>';
              echo '</div>';
...
<!--      <form>
        <div class="row" style="margin-top:10px;">
          <div class="small-12">
            <form method="post" name="addNewProducts" action="adminAddProducts.php">
            <center><input style="clear:both;" type="submit" class="button" value="Add New Product"></center>
            </form> -->
          </div>
