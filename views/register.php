...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Register || Ninja Art Online Junior Track</title>
...
<!-- End of Hippo Code -->
  ...
  <body style="background-image: url(../images/ninjaartbg2.jpg);">
    ...
    <form method="POST" action="../controller/insert-register.php" style="margin-top:30px;">
      <div class="row">
        <div class="small-8">
          ...
          <div class="row">
            ...
            <div class="small-8 columns">
              <input type="text" id="right-label" placeholder="Insert your first name." name="fname">
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
            ...
            <div class="small-8 columns">
              <input type="text" id="right-label" placeholder="Insert your last name." name="lname">
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
            ...
            <div class="small-8 columns">
              <input type="text" id="right-label" placeholder="Insert your address." name="address">
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
            ...
            <div class="small-8 columns">
              <input type="text" id="right-label" placeholder="Insert your city." name="city">
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
            ...
            <div class="small-8 columns">
              <input type="number" id="right-label" placeholder="Insert your pin code." name="pin">
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
            ...
            <div class="small-8 columns">
              <input type="email" id="right-label" placeholder="Insert your email address (ex. abc@gmail.com)." name="email">
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
