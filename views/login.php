...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Login || Ninja Art Online Junior Track</title>
...
<!-- End of Hippo Code -->
  ...
  <body style="background-image: url(../images/ninjaartbg2.jpg);">
    ...
    <form method="POST" action="../controller/verify.php" style="margin-top:30px;">
      <div class="row">
        <div class="small-8">
    ...
    <div class="row" style="margin-top:10px;">
      <div class="small-12">
        ...
        <footer>
           <center><p style="text-align:center; font-size:0.8em;">&copy; Kristine Costo. All Rights Reserved.</p>
           <p style="text-align:center; font-size:0.8em;">Powered by Serious Byte</p></center>           
        </footer>
